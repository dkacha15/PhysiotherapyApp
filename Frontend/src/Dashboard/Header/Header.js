...
const Header = (props) => {
  ...
  const handleOpenMenu = (event) => {
    ...
    } else if(event.currentTarget.getAttribute("aria-controls") === "Services") {
      setAnchorElService(event.currentTarget);
    } else if(event.currentTarget.getAttribute("aria-controls") === "userMenu") {
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenMenu} sx={{ p: 0 }} aria-controls="userMenu">
                <Avatar alt="Remy Sharp" src="http://cdn.onlinewebfonts.com/svg/img_243887.png" />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
